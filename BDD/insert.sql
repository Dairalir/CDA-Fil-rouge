USE `ecommerce`;
INSERT INTO `fournisseur`(id, name, address, city, postal_code, country) VALUES
...
INSERT INTO `employe`(id, surname, name, address, city, postal_code) VALUES
...
INSERT INTO `client`(id, surname, name, address, city, postal_code, country, phone, mail, pro, coef, employe_id) VALUES
...
INSERT INTO `produit`(id, name, description, price, picture, stock, active, sous_rubrique_id, fournisseur_id) VALUES
...
;
INSERT IGNORE INTO `commande`(id, produit_id, client_id, shipping_address, shipping_cp, shipping_city, facturation_address, facturation_cp, facturation_city, date, quantity, reduction, tva) VALUES
